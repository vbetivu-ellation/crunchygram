...
import { API } from "../../api";
import { arePostsLoading, getPostList, getSearchQuery } from "../selectors/post";

const setPostsLoading = dispatch => payload =>
  dispatch({type: SET_POSTS_LOADING, payload});

const fetchPosts = (dispatch, state) => async ({start = 0} = {}) => {
...
export const setSearchQueryAction = dispatch => payload => dispatch({
